...
setInterval(() => {
  http.get(`http://smart11.glitch.me/`); //تعديل مهم حط اسم المشروع
}, 280000);
...
const GUILDID = '735942404330225835'; //  تعديل مهم ايدي السيرفر  
const CHANNELID = '769925121916797040'; // تعديل مهم ايدي الروم الصوتي
...
//تغير الحالة
const developers = ["528024010282369037","","",""] ///تعديل مهم حط هنا ايدي اللي بدك يتحكمو بالحالة
